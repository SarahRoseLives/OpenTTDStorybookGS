...
class FMainClass extends GSInfo {
	function GetAuthor()		{ return "[SarahRoseLives]"; }
	function GetName()			{ return "Server Storybook"; }
	function GetDescription() 	{ return "A storybook script to display your rules, commands, etc."; }
	function GetVersion()		{ return SELF_VERSION; }
	function GetDate()			{ return "20214-06-05"; }
	function CreateInstance()	{ return "MainClass"; }
	function GetShortName()		{ return "STRY"; } // Replace this with your own unique 4 letter string
